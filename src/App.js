...
const C = {
  primary:"#D44C7A", primary50:"#E8829E", primary25:"#F4C0CE",
  primaryBg:"#FDE8EE", yellow:"#F5B731", dark:"#1A1A2E",
  dark50:"#555566", dark25:"#AAAAAA", border:"#F0D0DA",
  bg:"#FDF6F8", white:"#FFFFFF",
};

// ── Real HEYTEA menu data ─────────────────────────────
const HEYTEA_MENU = [
  // IN SEASON
  { id:101, brand:"喜茶", category:"IN SEASON", name:"Very Tangerine Blast", nameZH:"橘子冰茶", price:"S$6.82", tags:["绿茶","布丁","波波"], emoji:"🍊", desc:"鲜剥蜜橘配皇家碧螺绿茶，搭配桂花布丁和波波。" },
  // REFRESHING
  { id:102, brand:"喜茶", category:"清爽系列", name:"Mango Grapefruit Pops", nameZH:"芒果西柚波波", price:"S$6.54", tags:["芒果","西柚","波波"], emoji:"🥭", desc:"新鲜芒果配碧螺绿茶与西柚果肉，加脆波波。" },
  { id:103, brand:"喜茶", category:"清爽系列", name:"Very Mango Tea", nameZH:"芒果茶", price:"S$7.98", tags:["芒果","绿茶"], emoji:"🥭", desc:"时令芒果配清爽碧螺绿茶，热带甜蜜体验。" },
  { id:104, brand:"喜茶", category:"清爽系列", name:"Very Grapefruit Boom", nameZH:"西柚爆爆", price:"S$5.03", tags:["西柚","茉莉绿茶"], emoji:"🍋", desc:"清爽西柚果肉配茉莉绿茶，沁人心脾。" },
  { id:105, brand:"喜茶", category:"清爽系列", name:"Very Strawberry Peach Fusion", nameZH:"草莓蜜桃融合", price:"S$7.89", tags:["草莓","蜜桃","绿茶"], emoji:"🍓", desc:"草莓芝士与蜜桃芝士的梦幻融合。" },
  { id:106, brand:"喜茶", category:"清爽系列", name:"Emblic Superfruit Refresher", nameZH:"余甘超级水果茶", price:"S$7.71", tags:["余甘果","绿茶"], emoji:"🌿", desc:"余甘超级水果与碧螺绿茶的健康美味，七分甜三分酸。" },
  // SIGNATURE
  { id:107, brand:"喜茶", category:"招牌系列", name:"Very Grape Cheezo", nameZH:"多肉葡萄芝士", price:"S$9.32", tags:["葡萄","芝士","绿茶"], emoji:"🍇", desc:"2018年原创。手剥巨峰葡萄配优质绿茶。" },
  { id:108, brand:"喜茶", category:"招牌系列", name:"Grapefruit Boom (Original)", nameZH:"原创西柚爆爆", price:"S$6.19", tags:["西柚","茉莉绿茶"], emoji:"🍋", desc:"2016年原创。新鲜西柚果肉配茉莉绿茶。" },
  { id:109, brand:"喜茶", category:"招牌系列", name:"Very Mango Grapefruit Fusion", nameZH:"芒果西柚融合", price:"S$8.33", tags:["芒果","西柚","椰奶","波波"], emoji:"🥭", desc:"芒果+西柚+椰奶+绿茶+波波，夏日必喝。" },
  { id:110, brand:"喜茶", category:"招牌系列", name:"Mango Cheezo (Original)", nameZH:"多肉芒果芝士", price:"S$9.32", tags:["芒果","芝士","绿茶"], emoji:"🥭", desc:"2017年原创。时令芒果配碧螺绿茶与芝士。" },
  // COMFORT
  { id:111, brand:"喜茶", category:"醇厚系列", name:"Roasted Brown BoBo Milk w/Cheezo", nameZH:"芝士黑糖波波鲜奶", price:"S$5.92", tags:["黑糖","波波","芝士","鲜奶"], emoji:"🖤", desc:"2012年原创。黑糖波波配鲜奶芝士，浓郁醇厚。" },
  { id:112, brand:"喜茶", category:"醇厚系列", name:"Brown Bobo Milk", nameZH:"黑糖波波鲜奶", price:"S$4.04", tags:["黑糖","波波","鲜奶"], emoji:"🥛", desc:"黑糖波波与优质鲜奶，丝滑浓醇。" },
  { id:113, brand:"喜茶", category:"醇厚系列", name:"Roasted Brown Bobo Milk Tea w/Cheezo", nameZH:"芝士黑糖波波奶茶", price:"S$6.47", tags:["红茶","黑糖","波波","芝士"], emoji:"🧋", desc:"红茶奶茶底配黑糖波波与芝士。" },
  { id:114, brand:"喜茶", category:"醇厚系列", name:"Taro Bobo Milk Tea", nameZH:"芋泥波波奶茶", price:"S$4.22", tags:["芋泥","波波","奶茶"], emoji:"🟣", desc:"芋泥+芋泥波波，纯芋泥爱好者必选。" },
  // SIMPLE CLASSICS
  { id:115, brand:"喜茶", category:"经典系列", name:"Pure Aqua Green Jasmine Milk Tea", nameZH:"纯茉莉绿奶茶", price:"S$3.23", tags:["绿茶","茉莉","鲜奶","布丁"], emoji:"🍵", desc:"碧螺绿茶配鲜奶与桂花布丁。" },
  { id:116, brand:"喜茶", category:"经典系列", name:"Regal Aqua Green Jasmine Cheezo", nameZH:"芝士茉莉绿茶", price:"S$3.85", tags:["绿茶","茉莉","芝士"], emoji:"🍵", desc:"2012年原创芝士茶，世界各地茶叶精选。" },
  { id:117, brand:"喜茶", category:"经典系列", name:"Pure Regal Aqua Green Jasmine Tea", nameZH:"纯茉莉绿茶", price:"S$2.96", tags:["绿茶","茉莉"], emoji:"🍵", desc:"优质绿茶，清爽茉莉香气，简单纯粹。" },
  // ICE CREAM
  { id:118, brand:"喜茶", category:"冰淇淋", name:"BOBO SUNDAE", nameZH:"波波圣代", price:"S$4.30", tags:["冰淇淋","黑糖","波波"], emoji:"🍦", desc:"浓郁奶茶冰淇淋配黑糖波波。" },
];
...
const INIT_USERS = {
  alice:{ pw:"123", name:"Alice", avatar:"🐰", favTags:["波波","芝士"], unlocked:[101,102,103,107,111,114,116], favorites:[107,114], reviews:{} },
  bob:  { pw:"456", name:"Bob",   avatar:"🐻", favTags:["芒果","绿茶"], unlocked:[101,102,103,104,105,115,117], favorites:[103], reviews:{} },
};
...
function BtnPrimary({children,onClick,style={}}) {
  return (
    <button onClick={onClick} style={{background:`linear-gradient(135deg,${C.primary},${C.primary50})`,
      color:"white",border:"none",borderRadius:12,padding:"11px 24px",fontWeight:700,
      fontSize:14,cursor:"pointer",boxShadow:`0 4px 16px ${C.primary}44`,
...
function TeaCard({ t, unlocked, onView, onFav, isFav }) {
  const colors = ["#D44C7A","#7C3AED","#059669","#D97706","#2563EB","#DB2777"];
      ...
      <div style={{padding:"12px 14px"}}>
        ...
        {unlocked && (<>
          ...
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}>
            ...
            <span style={{fontSize:10,color:C.dark25,background:"#F3F4F6",
              borderRadius:6,padding:"2px 7px"}}>{t.category}</span>
          </div>
        </>)}
        {!unlocked && (
...
export default function App() {
  ...
  const u = curUser ? users[curUser] : null;
  const isUnlocked = id => u?.unlocked.includes(id);
  const isFav = id => u?.favorites.includes(id);

  const toggleFav = id => setUsers(p=>({...p,[curUser]:{...p[curUser],
    favorites:p[curUser].favorites.includes(id)
      ?p[curUser].favorites.filter(x=>x!==id)
      :[...p[curUser].favorites,id]
  }}));

  const login = () => {
    const usr=users[authForm.user];
    if(!usr) return setAuthErr("用户不存在");
    if(usr.pw!==authForm.pw) return setAuthErr("密码错误");
    setCurUser(authForm.user);setAuthErr("");setPage("home");
  };
  const register = () => {
    if(!authForm.user||!authForm.pw||!authForm.name) return setAuthErr("请填写所有字段");
    if(users[authForm.user]) return setAuthErr("用户名已存在");
    setUsers(p=>({...p,[authForm.user]:{pw:authForm.pw,name:authForm.name,avatar:authForm.avatar,
      favTags:[],unlocked:[101,102,103],favorites:[],reviews:{}}}));
    setCurUser(authForm.user);setAuthErr("");setPage("home");
  };
  const submitReview = teaId => {
    if(!reviewRating||!reviewText.trim()) return;
    setUsers(p=>({...p,[curUser]:{...p[curUser],reviews:{...p[curUser].reviews,
      [teaId]:{rating:reviewRating,text:reviewText,time:new Date().toLocaleDateString("zh-CN")}}}}));
    setReviewText("");setReviewRating(0);
  };

  const total = HEYTEA_MENU.length;
  const unlockedCount = u ? HEYTEA_MENU.filter(t=>isUnlocked(t.id)).length : 0;
  ...
  if(!curUser) return (
    <div style={{minHeight:"100vh",background:`linear-gradient(135deg,${C.primaryBg},#F3E8FF)`,
      ...
      <div style={{background:C.white,borderRadius:28,padding:"40px 36px",width:"100%",maxWidth:420,
        ...
        <div style={{display:"flex",background:C.primaryBg,borderRadius:14,padding:4,marginBottom:22}}>
          {[["login","登录"],["register","注册"]].map(([m,lb])=>(
            <button key={m} onClick={()=>{setAuthMode(m);setAuthErr("");}}
              style={{flex:1,border:"none",borderRadius:12,padding:"9px 0",fontWeight:700,fontSize:14,
                cursor:"pointer",transition:"all .2s",background:authMode===m?C.white:"transparent",
                color:authMode===m?C.primary:C.dark50,boxShadow:authMode===m?"0 2px 8px #D44C7A22":"none"}}>
              {lb}
            </button>
          ))}
        </div>
        ...
        <BtnPrimary onClick={authMode==="login"?login:register} style={{width:"100%",padding:14}}>
          {authMode==="login"?"🌸 登录":"✨ 注册"}
        </BtnPrimary>
        <div style={{textAlign:"center",marginTop:14,fontSize:12,color:C.dark25}}>
          测试：alice / 123 &nbsp;·&nbsp; bob / 456
        </div>
      </div>
    </div>
  );
  ...
  // ── DETAIL ─────────────────────────────────────────
  if(detail) {
    const t=detail; const ul=isUnlocked(t.id); const myR=u.reviews[t.id];
        ...
        <div style={{background:`linear-gradient(135deg,${col}33,${col}11)`,padding:"28px 28px 32px"}}>
          <button onClick={()=>setDetail(null)}
            style={{background:"white",border:"none",borderRadius:12,padding:"8px 16px",
              ...
              boxShadow:"0 2px 8px #0001"}}>← 返回菜单</button>
            ...
            <div style={{flex:1,minWidth:220}}>
              {ul?(<>
                <div style={{fontSize:11,fontWeight:700,color:col,textTransform:"uppercase",
                  letterSpacing:1,marginBottom:4}}>{t.category} · 喜茶 HEYTEA</div>
                <div style={{fontSize:28,fontWeight:900,color:C.dark,marginBottom:2}}>{t.nameZH}</div>
                <div style={{fontSize:15,color:C.dark50,marginBottom:14}}>{t.name}</div>
                <div style={{display:"flex",gap:6,flexWrap:"wrap",marginBottom:16}}>
                  {t.tags.map(tag=>(
                    <span key={tag} style={{background:C.primaryBg,color:C.primary,
                      fontSize:13,borderRadius:10,padding:"4px 12px",fontWeight:600}}>{tag}</span>
                  ))}
                </div>
                ...
                <div>
                  ...
                  <div style={{color:C.dark50}}>解锁更多奶茶来揭晓这款！</div>
                </div>
              )}
            </div>
          </div>
          ...
          {ul&&<>
            ...
            {!myR?(
              <div style={{background:C.white,borderRadius:20,padding:20,marginBottom:20,
                ...
                <BtnPrimary onClick={()=>submitReview(t.id)} style={{marginTop:12}}>发布</BtnPrimary>
              </div>
            ):(
              <div style={{background:C.primaryBg,borderRadius:20,padding:20,
                border:`1.5px solid ${C.border}`}}>
                <div style={{fontWeight:700,color:C.primary,marginBottom:6}}>✅ 你的评价</div>
                <Stars val={myR.rating}/>
                <div style={{color:C.dark,margin:"8px 0 4px",lineHeight:1.6}}>{myR.text}</div>
                <div style={{fontSize:12,color:C.dark25}}>{myR.time}</div>
              </div>
            )}
          </>}
        </div>
    ...
    <div style={{fontFamily:"'PingFang SC',sans-serif",minHeight:"100vh",background:C.bg}}>
      ...
      <nav style={{background:C.white,borderBottom:`1px solid ${C.border}`,padding:"0 32px",
        ...
        <div style={{display:"flex",alignItems:"center",gap:8}}>
          ...
          <span style={{fontWeight:600,color:C.dark,fontSize:14}}>{u.name}</span>
          <button onClick={()=>setCurUser(null)}
            style={{background:C.primaryBg,border:"none",borderRadius:10,padding:"5px 12px",
              fontSize:13,color:C.primary,fontWeight:600,cursor:"pointer"}}>退出</button>
        </div>
      </nav>
      ...
      <div style={{maxWidth:1200,margin:"0 auto",padding:"28px 24px"}}>
        ...
        {page==="home"&&<>
          ...
          <div style={{background:`linear-gradient(135deg,${C.primary},${C.primary50})`,
            ...
            <div style={{zIndex:2}}>
              <div style={{color:"white",opacity:.8,fontSize:13,marginBottom:6}}>欢迎回来 {u.avatar} {u.name}！</div>
              <div style={{color:"white",fontSize:34,fontWeight:900,lineHeight:1.2,marginBottom:20}}>
                喜茶菜单<br/>全攻略 🧋
              </div>
              <div style={{display:"flex",background:"white",borderRadius:14,
                padding:"10px 16px",gap:8,alignItems:"center",maxWidth:340,
          ...
          {/* STATS CARD — total / unlocked / locked */}
          <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:16,marginBottom:32}}>
            {[
              ...
              {label:"未解锁",val:lockedCount,icon:"🔒",color:"#6B7280",sub:"还在等你探索"},
          ...
          <div style={{background:C.white,borderRadius:20,padding:"20px 24px",marginBottom:32,
            ...
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:10}}>
              <div style={{fontWeight:700,color:C.dark,fontSize:15}}>🗺️ 探索进度</div>
              <div style={{fontWeight:700,color:C.primary}}>{unlockedCount}/{total}</div>
            </div>
            <ProgressBar value={unlockedCount} max={total}/>
            <div style={{display:"flex",justifyContent:"space-between",marginTop:8,fontSize:12,color:C.dark25}}>
              <span>0</span>
              {ALL_CATEGORIES.filter(c=>c!=="全部").map(cat=>{
                const catTotal=HEYTEA_MENU.filter(t=>t.category===cat).length;
                const catUnlocked=HEYTEA_MENU.filter(t=>t.category===cat&&isUnlocked(t.id)).length;
                return (
                  <div key={cat} style={{textAlign:"center"}}>
                    <div style={{fontWeight:600,color:catUnlocked===catTotal?C.primary:C.dark50}}>
          ...
          {ALL_CATEGORIES.filter(c=>c!=="全部").map(cat=>{
            ...
            const catUnlocked = catTeas.filter(t=>isUnlocked(t.id)).length;
            return (
              <div key={cat} style={{marginBottom:32}}>
                <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:14}}>
                  <div style={{fontWeight:800,fontSize:17,color:C.dark}}>{cat}
                    <span style={{marginLeft:8,fontSize:13,fontWeight:500,color:C.dark50}}>
                      ({catUnlocked}/{catTeas.length} 已解锁)
                    </span>
                  </div>
                  <button onClick={()=>{setCatF(cat);setPage("menu");}}
                    style={{background:C.primaryBg,border:"none",borderRadius:10,
                      padding:"5px 12px",fontSize:13,color:C.primary,fontWeight:600,cursor:"pointer"}}>
                    查看全部 →
                  </button>
                </div>
            ...
            {ALL_CATEGORIES.map(c=>(
              <button key={c} onClick={()=>setCatF(c)}
                style={{border:"none",borderRadius:99,padding:"7px 16px",fontSize:13,fontWeight:600,
                  ...
                  background:catF===c?C.primary:C.primaryBg,
                  color:catF===c?C.white:C.primary}}>
                {c}
                {c!=="全部"&&<span style={{marginLeft:5,opacity:.7,fontSize:11}}>
                  ({HEYTEA_MENU.filter(t=>t.category===c&&isUnlocked(t.id)).length}/
                  {HEYTEA_MENU.filter(t=>t.category===c).length})
                </span>}
              </button>
            ))}
          </div>
          {filtered.length===0
            ?<div style={{textAlign:"center",padding:60,color:C.dark25}}>
        ...
        {page==="favorites"&&<>
          ...
          {u.favorites.length===0
            ...
            :<div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(190px,1fr))",gap:16}}>
              {u.favorites.map(id=>{const t=HEYTEA_MENU.find(x=>x.id===id);return t&&(
                <TeaCard key={id} t={t} unlocked={isUnlocked(id)}
                  onView={setDetail} onFav={toggleFav} isFav={true}/>
              );})}
            </div>
          }
        </>}
        ...
        {page==="profile"&&(
          <div style={{maxWidth:700,margin:"0 auto"}}>
            <div style={{background:`linear-gradient(135deg,${C.primary},${C.primary50})`,
              borderRadius:24,padding:"36px 40px",marginBottom:24,
              display:"flex",alignItems:"center",gap:24}}>
              <div style={{fontSize:68}}>{u.avatar}</div>
              <div>
                <div style={{color:"white",fontWeight:900,fontSize:24}}>{u.name}</div>
                <div style={{color:"white",opacity:.75,marginBottom:14,fontSize:13}}>@{curUser}</div>
                <div style={{display:"flex",gap:28}}>
                  {[["解锁",unlockedCount],["收藏",u.favorites.length],["评价",Object.keys(u.reviews).length]].map(([lb,v])=>(
            ...
            {/* progress */}
            <div style={{background:C.white,borderRadius:20,padding:22,marginBottom:20,
              boxShadow:"0 2px 12px #D44C7A0D"}}>
            ...
            <div style={{background:C.white,borderRadius:20,padding:22,marginBottom:20,
              ...
              <div style={{display:"flex",gap:8,flexWrap:"wrap"}}>
                {ALL_TAGS.map(tag=>{
                  const sel=u.favTags.includes(tag);
                  return (
                    <button key={tag} onClick={()=>setUsers(p=>({...p,[curUser]:{...p[curUser],
                      favTags:sel?p[curUser].favTags.filter(x=>x!==tag):[...p[curUser].favTags,tag]}}))}
            ...
            {/* reviews */}
            <div style={{background:C.white,borderRadius:20,padding:22,
              boxShadow:"0 2px 12px #D44C7A0D"}}>
              <div style={{fontWeight:700,color:C.dark,marginBottom:12}}>✍️ 我的评价</div>
              {Object.entries(u.reviews).length===0
                ?<div style={{color:C.dark25,fontSize:14}}>还没有写过评价</div>
                :Object.entries(u.reviews).map(([id,r])=>{
                  const t=HEYTEA_MENU.find(x=>x.id===+id);
                  return t&&(
                    <div key={id} style={{borderTop:`1px solid ${C.border}`,paddingTop:12,marginTop:12}}>
                      <div style={{display:"flex",justifyContent:"space-between",marginBottom:3}}>
                        <span style={{fontWeight:700,color:C.dark}}>{t.nameZH}</span>
                        <Stars val={r.rating} size={13}/>
                      </div>
                      <div style={{color:C.dark50,fontSize:14,marginBottom:3}}>{r.text}</div>
                      <div style={{fontSize:11,color:C.dark25}}>{r.time}</div>
                    </div>
                  );
                })}
            </div>
            <div style={{textAlign:"center",marginTop:20}}>
              <button onClick={()=>setCurUser(null)}
                style={{background:C.primaryBg,border:"none",borderRadius:12,padding:"10px 24px",
                  color:C.primary,fontWeight:700,fontSize:14,cursor:"pointer"}}>退出登录</button>
            </div>
          </div>
        )}
      </div>
